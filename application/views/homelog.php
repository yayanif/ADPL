					...
					<div class="mega-dropdown-menu">
						<div class="w3ls_vegetables">
							<ul class="dropdown-menu drp-mnu">
								...
								<li><a href="<?php echo base_url();?>index.php/input">Masukkan Pesewaan</a></li> 
...
<!-- banner -->
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
					...
					<ul class="slides">
						<li>
							<div class="w3l_banner_nav_right_banner">
								<h3>Cari<span>Kost</span> Impian?</h3>
								<div class="more">
						...
						<li>
							<div class="w3l_banner_nav_right_banner1">
								<h3>Atau<span>Kontrakan</span> Terkeren?</h3>
								<div class="more">
									<a href="#" class="button--saqui button--round-l button--text-thick" data-text="Shop now">Shop now</a>
								</div>
							</div>
			...
			<!-- flexSlider -->
				<link rel="stylesheet" href="<?php echo base_url();?>asset/cs/flexslider.css" type="text/css" media="screen" property="" />
				<script defer src="<?php echo base_url();?>asset/j/jquery.flexslider.js"></script>
				<script type="text/javascript">
