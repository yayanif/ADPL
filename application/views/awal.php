	...
	<div class="center-container">
		...
		<div class="main-content-agile">
			<div class="wthree-pro">
				<h2>Mencari Kost atau Kontrakan?</h2>
			</div>
			<div class="w3-head-continue">
						<h4>Silahkan Pilih Jalan Anda</h4>
					</div>
					
					<div>
						<img src="<?php echo base_url();?>asset/images/logobr.png" style="width:200px;height:150px;">
					</div>
					...
					<div class="social_icons">
						...
						<div class="slide-social w3l">
						<a href="<?php echo base_url();?>index.php/homenon">
