...
<!-- //js -->
 <script src='<?php echo base_url();?>asset/j/okzoom.js'></script>
  <script>
    $(function(){
      $('#example').okzoom({
        width: 150,
			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						<li><a href="products.html">Kontrakan</a></li>
						<li><a href="household.html">Kos-kosan</a></li>
					</ul>
				 </div><!-- /.navbar-collapse -->
			</nav>
		</div>
		<div class="w3l_banner_nav_right">
			<div class="agileinfo_single">
				...
				<div class="col-md-4 agileinfo_single_left">
					<img id="example" src="<?php echo base_url();?>asset/images/76.png" alt=" " class="img-responsive" />
				</div>
...
<script src="<?php echo base_url();?>asset/j/minicart.js"></script>
<script>
